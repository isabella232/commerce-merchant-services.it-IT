...
![Problema risolto](../assets/fix.svg)<!-- Issue BOLT-452 --> La [!DNL Quick Checkout] **Fai un tour** ora viene visualizzato un cursore a mano selezionabile quando si passa il mouse sopra di esso.

_19 aprile 2023_

![Problema risolto](../assets/fix.svg)<!-- Issue BOLT-596 --> La [!DNL Quick Checkout] La pagina Rapporti ora mostra correttamente il grafico Nuovi account quando si analizzano le date in base al formato ISO 8601.
...
![Nuovo](../assets/new.svg)<!-- Issue BOLT-520 --> Versione generale di disponibilità—[[!DNL Quick Checkout]](https://marketplace.magento.com/magento-quick-checkout.html) è ora preinstallato nelle versioni 2.4.6 e successive di Adobe Commerce Cloud.

![Problema risolto](../assets/fix.svg)<!-- Issue BOLT-592 --> Miglioramenti dell’esperienza utente durante l’ordine [Pannello di amministrazione](https://experienceleague.adobe.com/docs/commerce-merchant-services/quick-checkout/create-order-admin.html) utilizzo [Braintree](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/payments/stored-payment-methods.html) come metodo di pagamento. Questa funzionalità consente ai clienti di effettuare un ordine con Braintree come metodo di pagamento durante il pagamento quando [!DNL Quick Checkout] è abilitato.
...
![Problema risolto](../assets/fix.svg)<!-- Issue BOLT-567 --> Miglioramenti dell’esperienza utente quando [ordinazione](https://experienceleague.adobe.com/docs/commerce-merchant-services/quick-checkout/getting-started/onboarding.html) utilizzando [Consegna in negozio](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/delivery/basic-methods/shipping-in-store-delivery.html) con il metodo [!DNL Quick Checkout] disattivato.

![Problema risolto](../assets/fix.svg)<!-- Issue BOLT-569 --> Miglioramenti alla funzionalità di logout che consente ai consumatori di [disconnessione dalla rete Bolt](https://experienceleague.adobe.com/docs/commerce-merchant-services/quick-checkout/user-session-lifetime.html).
