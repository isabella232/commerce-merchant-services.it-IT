...
Queste note sulla versione descrivono le versioni più recenti di [!DNL Live Search] e includono:
...
* ![Bug](../assets/bug.svg) - La classificazione per &quot;Consigliato per te&quot; è supportata solo all’interno dei widget Live Search. Non è supportato con le funzionalità di ricerca predefinite di LUMA e PWA.
* ![Bug](../assets/bug.svg) - I facet di attributi di prezzo personalizzati non vengono riprodotti correttamente in LUMA, ma l’API li filtra correttamente.
