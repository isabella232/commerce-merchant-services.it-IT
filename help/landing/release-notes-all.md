...
description: Raccolta di note sulla versione per tutti i servizi Commerce
...
Utilizza la tabella seguente per trovare le note sulla versione e informazioni importanti relative a versioni specifiche di tutti i servizi Adobe Commerce.
...
<table>
  <tbody>
    <tr>
      ...
      <td><strong>Servizi di dati e integrazione</strong>
        <p>Scopri gli ultimi miglioramenti ai servizi di dati e integrazione che consentono a Commerce Services di connettersi ad altri servizi e alla maggiore sfera di Adobe di estensioni e prodotti.</p>
          <ul>
            <li><a href="https://experienceleague.adobe.com/docs/commerce-merchant-services/experience-platform-connector/release-notes.html?lang=en">Connettore Experience Platform</a></li>
