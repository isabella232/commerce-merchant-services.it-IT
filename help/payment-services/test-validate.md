...
Per verificare Apple Pay in modalità sandbox:

* Crea un [Account tester sandbox Apple](https://developer.apple.com/apple-pay/sandbox-testing/#create-a-sandbox-tester-account), completo di false carte di credito e informazioni di fatturazione.
...
Per verificare Apple Pay in modalità di produzione, devi [registrare i domini di produzione](https://developer.paypal.com/docs/checkout/apm/apple-pay/#register-your-live-domain).
