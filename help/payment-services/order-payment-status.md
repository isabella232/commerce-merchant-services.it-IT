...
* Se non hai negozi che utilizzano [!DNL Payment Services] in modalità Live, la selezione dell’origine dati viene impostata automaticamente su [!UICONTROL Sandbox]_.
