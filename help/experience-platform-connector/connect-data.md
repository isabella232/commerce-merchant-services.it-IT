...
Sebbene Commerce raccolga già i dati storici dell’ordine, è necessario completare diverse attività per inviare tali dati ad Experienci Platform. Le sezioni seguenti ti guidano attraverso il processo.
...
Per garantire che la cronologia degli ordini dei clienti possa essere inviata ad Experienci Platform, devi specificare le credenziali che collegano l’istanza Commerce ad Experienci Platform. Se hai già installato e attivato [Audience Activation](https://experienceleague.adobe.com/docs/commerce-admin/customers/audience-activation.html) hai già specificato le credenziali necessarie e puoi saltare questo passaggio. La procedura seguente illustra come installare e abilitare l’estensione Audience Activation:
